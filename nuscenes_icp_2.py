...
def main():
    ...
    nusc = NuScenes(version='v1.0-mini', dataroot=osp.join(dataroot, 'v1.0-mini'), verbose=True)
    scene = nusc.scene[2]
    ...
    for i in range(scene['nbr_samples']):
        ...
        w_M_src = w_M_target @ reg_p2p.transformation  # TODO: hint using target_M_src and w_M_target
